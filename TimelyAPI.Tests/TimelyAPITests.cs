...
namespace TimelyAPI.Tests
{
    ...
    public class TimelyAPITests
    {
        ...
        public void GlucosePredictionValueTest()
        {
            ...
            Arrange();
            //Act
            string strTestResult = test.ProcessMessage("Can you predict what the glucose value will be for lot 3261612 in 2 hours?", "test", ref session);
            //Assert
            double n;
        ...
        public void GlucosePredictionTimeTest()
        {
            ...
            Arrange();
            //Act
            string strTestResult = test.ProcessMessage("Can you predict when the glucose value for lot 3261612 will reach 1.0 g/l?", "test", ref session);
            //Assert
            DateTime n;
        ...
        public void PCVPredictionTest()
        {
            ...
            Arrange();
            //Act
            string strTestResult = test.ProcessMessage("Can you predict what the PCV value will be for lot 3261612 in 2 hours?", "test", ref session);
            //Assert
            double n;
            Assert.IsTrue(double.TryParse(strTestResult, out n));
            Console.WriteLine(strTestResult);
